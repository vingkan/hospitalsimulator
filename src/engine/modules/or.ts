    ...
    return [
      {
        ...
        min: 0.70,
        max: 0.85,
        source: 'OR management literature: optimal utilization range',
        severity: 'warning',
      },
      {
        ...
        min: 0.05,
        max: 0.15,
        source: 'OR management literature: baseline cancellation rate',
        severity: 'warning',
      },
      {
        metric: 'surgicalMargin',
        min: 0.15,
        max: 0.25,
        source: 'Highest margin service line in community hospitals',
        severity: 'fail',
      },
    ]
  },
